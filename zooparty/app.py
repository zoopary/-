...
LANGUAGES = {
    'zh': {
        ...
        'based_on_monitoring_data': '基于最近{days}天的监控数据'
    },
    'en': {
        # Navigation
        ...
        'avg_cpu_usage_rate': 'Avg CPU Usage',
        'max_cpu_usage_rate': 'Max CPU Usage',
        'avg_memory_usage_rate': 'Avg Memory Usage',
        'max_memory_usage_rate': 'Max Memory Usage',
        ...
        'based_on_monitoring_data': 'Based on monitoring data from the last {days} days'
    }
}
